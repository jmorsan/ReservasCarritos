package es.iesjandula.reservascarritos.exception;
...
public class ReservasException extends Exception
{
	...
	{
		this(ReservasException.DEFAULT_ERROR_CODE, ReservasException.DEFAULT_ERROR_MESSAGE);
	}

	/**
	 * Constructor by default with exception
	 */
	public ReservasException(Exception exception)
	{
		this(ReservasException.DEFAULT_ERROR_CODE, ReservasException.DEFAULT_ERROR_MESSAGE, exception);
	}
	 ...
	 */
	public ReservasException(String code, String message)
	{
		super(message);
	 ...
	 */
	public ReservasException(String code, String message, Exception exception)
	{
